...
def context_columns(dataframe):
    ...
    dataframe["Contexto del uso"].replace("Para el mueble de la cirqoid", "Interno/Desarrollo", inplace=True)
    dataframe["Contexto del uso"].replace("piezas para el mueble de la cirqoid", "Interno/Desarrollo", inplace=True)	
